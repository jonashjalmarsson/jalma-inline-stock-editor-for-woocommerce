...
class JISE_Rest_Controller {
	...
	public function list_variations( $request ) {
		...
		if ( ! $parent || ! $parent->is_type( 'variable' ) ) {
			return new WP_Error( 'jise_not_variable', __( 'Product is not a variable product.', 'jalma-inline-stock-editor' ), [ 'status' => 400 ] );
		}
	...
	public function update_product( $request ) {
		...
		if ( ! $product ) {
			return new WP_Error( 'jise_not_found', __( 'Product not found.', 'jalma-inline-stock-editor' ), [ 'status' => 404 ] );
		}
